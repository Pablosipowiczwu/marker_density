...
####The l loop will use a different Gmatrix built from 50 markers (10 different Gmatrices by randomly selecting 50 markers)
...
for (k in 1:11) {
  ...
  write.csv(r1,paste0(hn,'_AGP17_unrelated_50', '.csv'),quote=FALSE)
}
